...
#include "space_msgs/msg/detail/terrain_estimate__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const space_msgs::msg::TerrainEstimate & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  space_msgs::msg::TerrainEstimate & ros_message)
{
  // Member: header
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_space_msgs
max_serialized_size_TerrainEstimate(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = space_msgs::msg::TerrainEstimate;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_space_msgs
max_serialized_size_key_TerrainEstimate(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const space_msgs::msg::TerrainEstimate *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<space_msgs::msg::TerrainEstimate *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _TerrainEstimate__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const space_msgs::msg::TerrainEstimate *>(
...
static size_t _TerrainEstimate__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_TerrainEstimate(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _TerrainEstimate__callbacks = {
  "space_msgs::msg",
  "TerrainEstimate",
...
static rosidl_message_type_support_t _TerrainEstimate__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_TerrainEstimate__callbacks,
...
{
  return &space_msgs::msg::typesupport_fastrtps_cpp::_TerrainEstimate__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, space_msgs, msg, TerrainEstimate)() {
  return &space_msgs::msg::typesupport_fastrtps_cpp::_TerrainEstimate__handle;
}
