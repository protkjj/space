...
bool space_msgs__msg__traversability_score__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("space_msgs.msg._traversability_score.TraversabilityScore", full_classname_dest, 56) == 0);
  }
  space_msgs__msg__TraversabilityScore * ros_message = _ros_message;
  {  // header
  ...
  {  // rover_spec
    PyObject * field = PyObject_GetAttrString(_pymsg, "rover_spec");
    if (!field) {
      return false;
    }
    if (!space_msgs__msg__rover_spec__convert_from_py(field, &ros_message->rover_spec)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // terrain_stamp
    PyObject * field = PyObject_GetAttrString(_pymsg, "terrain_stamp");
    if (!field) {
      return false;
    }
    if (!builtin_interfaces__msg__time__convert_from_py(field, &ros_message->terrain_stamp)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // evaluator_version
    PyObject * field = PyObject_GetAttrString(_pymsg, "evaluator_version");
    if (!field) {
      return false;
    }
    assert(PyUnicode_Check(field));
    ...
    rosidl_runtime_c__String__assign(&ros_message->evaluator_version, PyBytes_AS_STRING(encoded_field));
    Py_DECREF(encoded_field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of TraversabilityScore */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("space_msgs.msg._traversability_score");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TraversabilityScore");
  ...
  {  // rover_spec
    PyObject * field = NULL;
    field = space_msgs__msg__rover_spec__convert_to_py(&ros_message->rover_spec);
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "rover_spec", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // terrain_stamp
    PyObject * field = NULL;
    field = builtin_interfaces__msg__time__convert_to_py(&ros_message->terrain_stamp);
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "terrain_stamp", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // evaluator_version
    PyObject * field = NULL;
    field = PyUnicode_DecodeUTF8(
      ros_message->evaluator_version.data,
      strlen(ros_message->evaluator_version.data),
      "replace");
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "evaluator_version", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
