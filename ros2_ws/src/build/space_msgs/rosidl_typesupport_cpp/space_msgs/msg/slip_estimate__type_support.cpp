...
static const _SlipEstimate_type_support_symbol_names_t _SlipEstimate_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, space_msgs, msg, SlipEstimate)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, space_msgs, msg, SlipEstimate)),
  }
};
...
{
  return &::space_msgs::msg::rosidl_typesupport_cpp::SlipEstimate_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, space_msgs, msg, SlipEstimate)() {
  return get_message_type_support_handle<space_msgs::msg::SlipEstimate>();
}
