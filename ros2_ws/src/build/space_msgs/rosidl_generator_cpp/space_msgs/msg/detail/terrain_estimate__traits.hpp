...
#ifndef SPACE_MSGS__MSG__DETAIL__TERRAIN_ESTIMATE__TRAITS_HPP_
#define SPACE_MSGS__MSG__DETAIL__TERRAIN_ESTIMATE__TRAITS_HPP_
...
inline std::string to_yaml(const TerrainEstimate & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const space_msgs::msg::TerrainEstimate & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const space_msgs::msg::TerrainEstimate & msg)
{
  return space_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<space_msgs::msg::TerrainEstimate>()
{
  return "space_msgs::msg::TerrainEstimate";
}

template<>
inline const char * name<space_msgs::msg::TerrainEstimate>()
{
  return "space_msgs/msg/TerrainEstimate";
}

template<>
struct has_fixed_size<space_msgs::msg::TerrainEstimate>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<space_msgs::msg::TerrainEstimate>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<space_msgs::msg::TerrainEstimate>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // SPACE_MSGS__MSG__DETAIL__TERRAIN_ESTIMATE__TRAITS_HPP_
