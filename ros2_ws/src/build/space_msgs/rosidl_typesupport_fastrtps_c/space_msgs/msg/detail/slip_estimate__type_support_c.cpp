...
#include "space_msgs/msg/detail/slip_estimate__rosidl_typesupport_fastrtps_c.h"
...
using _SlipEstimate__ros_msg_type = space_msgs__msg__SlipEstimate;
...
size_t get_serialized_size_space_msgs__msg__SlipEstimate(
  ...
  size_t current_alignment)
{
  const _SlipEstimate__ros_msg_type * ros_message = static_cast<const _SlipEstimate__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = space_msgs__msg__SlipEstimate;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const space_msgs__msg__SlipEstimate * ros_message = static_cast<const space_msgs__msg__SlipEstimate *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_space_msgs__msg__SlipEstimate(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  space_msgs__msg__SlipEstimate * ros_message = static_cast<space_msgs__msg__SlipEstimate *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_space_msgs__msg__SlipEstimate(cdr, ros_message);
}

static uint32_t _SlipEstimate__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_space_msgs__msg__SlipEstimate(
...
static size_t _SlipEstimate__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_space_msgs__msg__SlipEstimate(
...
static message_type_support_callbacks_t __callbacks_SlipEstimate = {
  "space_msgs::msg",
  "SlipEstimate",
...
static rosidl_message_type_support_t _SlipEstimate__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_SlipEstimate,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, space_msgs, msg, SlipEstimate)() {
  return &_SlipEstimate__type_support;
}
